...
public class MediaResource {
     ...
     */
    @GetMapping("/media")
    public ResponseEntity<List<MediaDTO>> getAllMedia(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
